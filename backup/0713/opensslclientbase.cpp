...
#define IP "127.0.0.1"
#define PORT 7838
#define CERT_PATH "/var/certs/clients/client.pem"
#define KEY_PATH  "/var/certs/clients/client.key"
#define CAFILE "/var/certs/clients/ca.pem"
...
static void sslctx_release(SSL_CTX *g_sslctx)
{
    EVP_cleanup();
    if(g_sslctx){
...
int connect_to_server(int fd , const char* ip,int port){
...
out:
    ...
    if(g_sslctx != NULL) sslctx_release(g_sslctx);
    return 0;
}
