...
static const bool DEFAULT_PEER_SSL_ENABLE = false;
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += "\n" + _("PEER SSL options: ") + "\n";
    strUsage += "  -peerssl                                  " + _("Use OpenSSL (tls) for peer connections") + "\n";
    strUsage += "  -peersslcertificatefile=<cert.pem>  " + _("Server certificate file (default: server.cert)") + "\n";
    strUsage += "  -peersslprivatekeyfile=<key.pem>         " + _("Server private key (default: server.pem)") + "\n";
    strUsage += "  -peersslcafile=<ca.pem>         " + _("Root ca certificate (default: cacert.pem)") + "\n";
    strUsage += "  -peersslciphers=<ciphers>                 " + _("Acceptable ciphers (default: TLSv1.2+HIGH:TLSv1+HIGH:!SSLv2:!aNULL:!eNULL:!3DES:@STRENGTH)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (GetBoolArg("-peerssl", false))
    	LoadCertsPath();
    else
        InitWarning(_("Disabled peer ssl connection, set parameter -peerssl=1 to turn on."));
